...
- **alphaXiv `discover_papers`** (MCP tool `mcp__alphaxiv__discover_papers`, from the separately connected alphaXiv server): natural-language topic discovery. Pass `keywords[]`, a `question`, and `difficulty` 1–10.
